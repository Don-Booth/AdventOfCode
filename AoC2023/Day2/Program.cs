...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        */
        ...
        games = LoadGamesIntoList("input.txt", bagMaximums);
        total = GetSumOfPossibleGameIDs(games);

        Console.WriteLine(total);

        // The correct answer is 2105
    }

    private static int GetSumOfPossibleGameIDs(List<Game> games)
    {
        int result = 0;
    ...
    private static List<Game> LoadGamesIntoList(string fileName, BagMaximums bagMaximums)
    {
